...
import { updateAutores } from '../../../services/autoresServices';

const EditarAutoresModal = ({ show, handleClose, onSuccess, data }) => {
    ...
    useEffect(() => {
        if (data) {
            setAutorNome(data.nome);
            setAutorAno(data.ano_nascimento);
            setAutorSexo(data.sexo);
            setAutorPais(data.pais_origem);
        }
    }, [data]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await updateAutores(updatedData);
            setToastMessage('Autor editado com sucesso!');
            ...
            setToastMessage("Erro ao editar autor.");
            ...
            <Modal show={show} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Form onSubmit={handleSubmit}>
                        <Form.Group className="mb-3" controlId="autorNome">
                        ...
                        <Form.Group className="mb-3" controlId="autorAno">
                        ...
                        <Form.Group className="mb-3" controlId="autorSexo">
                        ...
                        <Form.Group className="mb-3" controlId="autorPais">
...
export default EditarAutoresModal;