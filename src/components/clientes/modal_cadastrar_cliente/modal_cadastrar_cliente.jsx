...
import { createClientes } from '../../../services/clientesServices';
import axios from 'axios';

const CadastrarClientesModal = ({ show, handleClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await createClientes(clienteData);
...
export default CadastrarClientesModal;