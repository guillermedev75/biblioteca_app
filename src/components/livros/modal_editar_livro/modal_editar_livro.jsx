...
import { updateLivros } from '../../../services/livrosServices';
...
const EditarLivroModal = ({ show, handleClose, onSuccess, data }) => {
    console.log(data);
    //Aux
    ...
    useEffect(() => {
        if (data) {
            ...
            setIsbn(data.isbn);
            setCover(data.cover);
            setAutoresSelect(data.autor_id);
            setEditorasSelect(data.editora_id);
            setGenerosSelect(data.generos.map(genero => genero.id ))
        }
    }, [data]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setToastMessage("Erro ao atualizar o livro");
                    ...
                    <Form onSubmit={handleSubmit}>
                        ...
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            ...
                            <InputGroup>
                                ...
                                <Button className='col-md-2' variant="success" id="addEditora" onClick={handleShowAddEditora}>
                                    <div>
                                    <FontAwesomeIcon icon={faPlus} className="mr-2" />
                                    <span> Editora</span>
                                    </div>
